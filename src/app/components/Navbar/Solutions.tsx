...
const industriesData = [
  {
    ...
    icon: 'https://rippling2.imgix.net/construction-wrench-icon.svg'
  },
  {
    id: '030002',
    title: 'Financial Services',
    href: '/industries/financial-services',
    icon: 'https://rippling2.imgix.net/Finances.svg'
  },
  {
    id: '030003',
    title: 'Healthcare',
    href: '/industries/healthcare',
    icon: 'https://rippling2.imgix.net/Health.svg'
  },
  {
    id: '030004',
    title: 'Marketing & Ad Agencies',
    href: '/industries/marketing-advertising',
    icon: 'https://rippling2.imgix.net/Marketing-And-Advertising-1.svg'
  },
  {
    id: '030005',
    title: 'Manufacturing',
    href: '/industries/manufacturing',
    icon: 'https://rippling2.imgix.net/Tools-1.svg'
  },
  {
    id: '030006',
    title: 'Non-profit Organizations',
    href: '/industries/non-profits',
    icon: 'https://rippling2.imgix.net/Nonprofit.svg'
  },
  {
    id: '030007',
  ...
  },
  {
    ...
    icon: 'https://rippling2.imgix.net/Meals.svg'
  },
  {
    id: '030009',
    title: 'Retail',
    href: '/industries/retail',
    icon: 'https://rippling2.imgix.net/Retail-Dollar.svg'
  },
  {
    id: '030010',
    title: 'Technology',
    href: '/industries/technology',
    icon: 'https://rippling2.imgix.net/Technology.svg'
  }
];
...
const companySizeData = [
  {
    ...
    icon: 'https://rippling2.imgix.net/Star-empty-1.svg'
  },
  {
    id: '030012',
    title: 'Small Businesses',
    href: '/small-business',
    icon: 'https://rippling2.imgix.net/small-business-2.svg'
  },
  {
    id: '030013',
    title: 'Mid-Sized Businesses',
    href: '/mid-sized-businesses',
    icon: 'https://rippling2.imgix.net/mid-size-1.svg'
  },
  {
    id: '030014',
    title: 'Enterprise',
    href: '/enterprise',
    icon: 'https://rippling2.imgix.net/enterprise.svg'
  }
];
...
const partnersData = [
  {
    ...
    title: 'Brokers',
    href: '/brokers',
    icon: 'https://rippling2.imgix.net/Broker.svg'
  },
  {
    id: '030016',
    title: 'Accountants',
    href: '/accountants',
    icon: 'https://rippling2.imgix.net/Accountant-icon.svg'
  },
  {
    id: '030017',
    title: 'VC Firms & Accelerators',
    href: '/venture-firms-and-accelerators',
    icon: 'https://rippling2.imgix.net/Linechart.svg'
  },
  {
    id: '030018',
    title: 'Developers',
    href: '/developers',
    icon: 'https://rippling2.imgix.net/Engineering.svg'
  }
];
...
const integrationsData = [
  {
    id: '030019',
    title: 'Carta',
    href: 'https://www.rippling.com/app-shop/app/carta',
    icon: 'https://rippling2.imgix.net/icon-7.svg'
  },
  {
    id: '030020',
    title: 'Paypal',
    href: 'https://www.rippling.com/app-shop/app/paypal',
    icon: 'https://rippling2.imgix.net/paypal.svg'
  },
  {
    id: '030021',
    title: '1Password',
    href: 'https://www.rippling.com/app-shop/app/1-password',
    icon: 'https://rippling2.imgix.net/1pass.svg'
  },
  {
    id: '030022',
    title: 'Yubikey',
    href: 'https://www.rippling.com/app-shop/app/yubikey',
    icon: 'https://rippling2.imgix.net/yubikey.svg'
  }
];
...
export default function Solutions({ isOpen, onToggle, onClose }: SolutionsProps) {
