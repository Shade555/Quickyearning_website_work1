...
const globalProductsData: GlobalProductData[] = [
  {
    ...
    icon: 'https://diamondrock2.imgix.net/EOR.svg'
  },
  {
    id: '040002',
    ...
    icon: 'https://diamondrock2.imgix.net/global-payroll-3.svg'
  },
  {
    id: '040003',
    ...
    icon: 'https://diamondrock2.imgix.net/contractors.svg'
  },
  {
    id: '040004',
    title: 'Global HRIS',
    ...
    href: '/global-hr',
    icon: 'https://diamondrock2.imgix.net/people-directory-2-1.svg'
  },
  {
    id: '040005',
    ...
    icon: 'https://diamondrock2.imgix.net/need-to-talk-2.svg'
  },
  {
    id: '040006',
    ...
    icon: 'https://diamondrock2.imgix.net/benefits-admin-1.svg'
  },
  {
    id: '040007',
    title: 'Global Spend',
    ...
    href: '/global-spend',
    icon: 'https://diamondrock2.imgix.net/global-spend-1.svg'
  }
];
...
const globalResourcesData: GlobalResourceData[] = [
  {
    ...
    title: 'Hiring Guides',
    href: '/country-hiring',
    icon: 'https://diamondrock2.imgix.net/Guidepost.svg'
  },
  {
    id: '040009',
    title: 'Employee Cost Calculator',
    href: '/employee-cost-calculator',
    icon: 'https://diamondrock2.imgix.net/Dollar-Circle-1.svg'
  },
  {
    id: '040010',
    title: 'Misclassification Quiz',
    href: '/tools/worker-classification-analyzer',
    icon: 'https://diamondrock2.imgix.net/Question-Circle-1.svg'
  },
  {
    id: '040011',
    title: 'Entity vs. EOR Cost Calculator',
    href: '/entity-vs-eor-cost-calculator',
    icon: 'https://diamondrock2.imgix.net/calculator-icon.svg'
  },
  {
    id: '040012',
    title: 'Glossary',
    href: '/glossary',
    icon: 'https://diamondrock2.imgix.net/Spell-check.svg'
  }
];
...
const globalSolutionsData: GlobalSolutionData[] = [
  {
    ...
    icon: 'https://diamondrock2.imgix.net/Unified-System-2.svg'
  },
  {
    id: '040014',
    title: 'Global Only',
    href: '/global',
    icon: 'https://diamondrock2.imgix.net/Globe.svg'
  },
  {
    id: '040015',
    title: 'Contractor to EOR',
    href: '/convert-contractors-to-employees',
    icon: 'https://diamondrock2.imgix.net/Swap-1.svg'
  }
];
...
const globalCountriesData: GlobalCountryData[] = [
  {
    ...
    flag: 'https://diamondrock2.imgix.net/flag-UK.svg'
  },
  {
    id: '040018',
    title: 'Hire in Australia',
    href: '/country-hiring/australia-employees',
    flag: 'https://diamondrock2.imgix.net/flag-Australia.svg'
  },
  {
    id: '040019',
    title: 'Hire in Canada',
    href: '/country-hiring/canada-employees',
    flag: 'https://diamondrock2.imgix.net/flag-Canada.svg'
  }
];
...
export default function Global({ isOpen, onToggle, onClose, textColor, labelAnimation }: GlobalProps) {
      ...
      >
        {labelAnimation ? (
          <span className="relative h-6 overflow-hidden flex flex-col justify-center">
            <span className="block transition-transform duration-300 group-hover:-translate-y-6 group-focus:-translate-y-6">Global</span>
            <span className="block absolute left-0 top-0 w-full transition-transform duration-300 translate-y-6 group-hover:translate-y-0 group-focus:translate-y-0">Global</span>
          </span>
        ) : (
          <span>Global</span>
        )}
                            ...
                            >
                              <div className="resources__card p-4 rounded-lg border border-gray-200 hover:border-gray-300 hover:shadow-sm transition-all">
                                <div className="dropdown__customersTestimonialImage mb-3">
                                  <Image 
                                    src="https://diamondrock2.imgix.net/nav-global-hiring-report.png" 
